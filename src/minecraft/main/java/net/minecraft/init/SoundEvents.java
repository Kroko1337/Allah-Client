...
public class SoundEvents
{
    ...
    {
        SoundEvent soundevent = SoundEvent.REGISTRY.getOrDefault(new ResourceLocation(id));
    ...
    static
    {
        ...
        else
        {
            ...
            ENTITY_ARMOR_STAND_BREAK = getRegisteredSoundEvent("entity.armorstand.break");
            ENTITY_ARMOR_STAND_FALL = getRegisteredSoundEvent("entity.armorstand.fall");
            ENTITY_ARMOR_STAND_HIT = getRegisteredSoundEvent("entity.armorstand.hit");
            ENTITY_ARMOR_STAND_PLACE = getRegisteredSoundEvent("entity.armorstand.place");
            ...
            ENTITY_FISHING_BOBBER_RETRIEVE = getRegisteredSoundEvent("entity.bobber.retrieve");
            ENTITY_FISHING_BOBBER_SPLASH = getRegisteredSoundEvent("entity.bobber.splash");
            ENTITY_FISHING_BOBBER_THROW = getRegisteredSoundEvent("entity.bobber.throw");
            ...
            BLOCK_WOOL_BREAK = getRegisteredSoundEvent("block.cloth.break");
            BLOCK_WOOL_FALL = getRegisteredSoundEvent("block.cloth.fall");
            BLOCK_WOOL_HIT = getRegisteredSoundEvent("block.cloth.hit");
            BLOCK_WOOL_PLACE = getRegisteredSoundEvent("block.cloth.place");
            BLOCK_WOOL_STEP = getRegisteredSoundEvent("block.cloth.step");
            ...
            BLOCK_ENDER_CHEST_CLOSE = getRegisteredSoundEvent("block.enderchest.close");
            BLOCK_ENDER_CHEST_OPEN = getRegisteredSoundEvent("block.enderchest.open");
            ENTITY_ENDER_DRAGON_AMBIENT = getRegisteredSoundEvent("entity.enderdragon.ambient");
            ENTITY_ENDER_DRAGON_DEATH = getRegisteredSoundEvent("entity.enderdragon.death");
            ENTITY_DRAGON_FIREBALL_EXPLODE = getRegisteredSoundEvent("entity.enderdragon_fireball.explode");
            ENTITY_ENDER_DRAGON_FLAP = getRegisteredSoundEvent("entity.enderdragon.flap");
            ENTITY_ENDER_DRAGON_GROWL = getRegisteredSoundEvent("entity.enderdragon.growl");
            ENTITY_ENDER_DRAGON_HURT = getRegisteredSoundEvent("entity.enderdragon.hurt");
            ENTITY_ENDER_DRAGON_SHOOT = getRegisteredSoundEvent("entity.enderdragon.shoot");
            ENTITY_ENDER_EYE_DEATH = getRegisteredSoundEvent("entity.endereye.death");
            ENTITY_ENDER_EYE_LAUNCH = getRegisteredSoundEvent("entity.endereye.launch");
            ENTITY_ENDERMAN_AMBIENT = getRegisteredSoundEvent("entity.endermen.ambient");
            ENTITY_ENDERMAN_DEATH = getRegisteredSoundEvent("entity.endermen.death");
            ENTITY_ENDERMAN_HURT = getRegisteredSoundEvent("entity.endermen.hurt");
            ENTITY_ENDERMAN_SCREAM = getRegisteredSoundEvent("entity.endermen.scream");
            ENTITY_ENDERMAN_STARE = getRegisteredSoundEvent("entity.endermen.stare");
            ENTITY_ENDERMAN_TELEPORT = getRegisteredSoundEvent("entity.endermen.teleport");
            ...
            ENTITY_ENDER_PEARL_THROW = getRegisteredSoundEvent("entity.enderpearl.throw");
            ...
            ENTITY_EVOKER_FANGS_ATTACK = getRegisteredSoundEvent("entity.evocation_fangs.attack");
            ENTITY_EVOKER_AMBIENT = getRegisteredSoundEvent("entity.evocation_illager.ambient");
            ENTITY_EVOKER_CAST_SPELL = getRegisteredSoundEvent("entity.evocation_illager.cast_spell");
            ENTITY_EVOKER_DEATH = getRegisteredSoundEvent("entity.evocation_illager.death");
            ENTITY_EVOKER_HURT = getRegisteredSoundEvent("entity.evocation_illager.hurt");
            ENTITY_EVOKER_PREPARE_ATTACK = getRegisteredSoundEvent("entity.evocation_illager.prepare_attack");
            ENTITY_EVOKER_PREPARE_SUMMON = getRegisteredSoundEvent("entity.evocation_illager.prepare_summon");
            ENTITY_EVOKER_PREPARE_WOLOLO = getRegisteredSoundEvent("entity.evocation_illager.prepare_wololo");
            ...
            ENTITY_FIREWORK_ROCKET_BLAST = getRegisteredSoundEvent("entity.firework.blast");
            ENTITY_FIREWORK_ROCKET_BLAST_FAR = getRegisteredSoundEvent("entity.firework.blast_far");
            ENTITY_FIREWORK_ROCKET_LARGE_BLAST = getRegisteredSoundEvent("entity.firework.large_blast");
            ENTITY_FIREWORK_ROCKET_LARGE_BLAST_FAR = getRegisteredSoundEvent("entity.firework.large_blast_far");
            ENTITY_FIREWORK_ROCKET_LAUNCH = getRegisteredSoundEvent("entity.firework.launch");
            ENTITY_FIREWORK_ROCKET_SHOOT = getRegisteredSoundEvent("entity.firework.shoot");
            ENTITY_FIREWORK_ROCKET_TWINKLE = getRegisteredSoundEvent("entity.firework.twinkle");
            ENTITY_FIREWORK_ROCKET_TWINKLE_FAR = getRegisteredSoundEvent("entity.firework.twinkle_far");
            ...
            ENTITY_ILLUSIONER_AMBIENT = getRegisteredSoundEvent("entity.illusion_illager.ambient");
            ENTITY_ILLUSIONER_CAST_SPELL = getRegisteredSoundEvent("entity.illusion_illager.cast_spell");
            ENTITY_ILLUSIONER_DEATH = getRegisteredSoundEvent("entity.illusion_illager.death");
            ENTITY_ILLUSIONER_HURT = getRegisteredSoundEvent("entity.illusion_illager.hurt");
            ENTITY_ILLUSIONER_MIRROR_MOVE = getRegisteredSoundEvent("entity.illusion_illager.mirror_move");
            ENTITY_ILLUSIONER_PREPARE_BLINDNESS = getRegisteredSoundEvent("entity.illusion_illager.prepare_blindness");
            ENTITY_ILLUSIONER_PREPARE_MIRROR = getRegisteredSoundEvent("entity.illusion_illager.prepare_mirror");
            ENTITY_IRON_GOLEM_ATTACK = getRegisteredSoundEvent("entity.irongolem.attack");
            ENTITY_IRON_GOLEM_DEATH = getRegisteredSoundEvent("entity.irongolem.death");
            ENTITY_IRON_GOLEM_HURT = getRegisteredSoundEvent("entity.irongolem.hurt");
            ENTITY_IRON_GOLEM_STEP = getRegisteredSoundEvent("entity.irongolem.step");
            ...
            ENTITY_ITEM_FRAME_ADD_ITEM = getRegisteredSoundEvent("entity.itemframe.add_item");
            ENTITY_ITEM_FRAME_BREAK = getRegisteredSoundEvent("entity.itemframe.break");
            ENTITY_ITEM_FRAME_PLACE = getRegisteredSoundEvent("entity.itemframe.place");
            ENTITY_ITEM_FRAME_REMOVE_ITEM = getRegisteredSoundEvent("entity.itemframe.remove_item");
            ENTITY_ITEM_FRAME_ROTATE_ITEM = getRegisteredSoundEvent("entity.itemframe.rotate_item");
            ...
            ENTITY_LEASH_KNOT_BREAK = getRegisteredSoundEvent("entity.leashknot.break");
            ENTITY_LEASH_KNOT_PLACE = getRegisteredSoundEvent("entity.leashknot.place");
            BLOCK_LEVER_CLICK = getRegisteredSoundEvent("block.lever.click");
            ENTITY_LIGHTNING_BOLT_IMPACT = getRegisteredSoundEvent("entity.lightning.impact");
            ENTITY_LIGHTNING_BOLT_THUNDER = getRegisteredSoundEvent("entity.lightning.thunder");
            ENTITY_LINGERING_POTION_THROW = getRegisteredSoundEvent("entity.lingeringpotion.throw");
            ...
            ENTITY_MAGMA_CUBE_DEATH = getRegisteredSoundEvent("entity.magmacube.death");
            ENTITY_MAGMA_CUBE_HURT = getRegisteredSoundEvent("entity.magmacube.hurt");
            ENTITY_MAGMA_CUBE_JUMP = getRegisteredSoundEvent("entity.magmacube.jump");
            ENTITY_MAGMA_CUBE_SQUISH = getRegisteredSoundEvent("entity.magmacube.squish");
            ...
            BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF = getRegisteredSoundEvent("block.metal_pressureplate.click_off");
            BLOCK_METAL_PRESSURE_PLATE_CLICK_ON = getRegisteredSoundEvent("block.metal_pressureplate.click_on");
            ...
            BLOCK_NOTE_BLOCK_BASEDRUM = getRegisteredSoundEvent("block.note.basedrum");
            BLOCK_NOTE_BLOCK_BASS = getRegisteredSoundEvent("block.note.bass");
            BLOCK_NOTE_BLOCK_BELL = getRegisteredSoundEvent("block.note.bell");
            BLOCK_NOTE_BLOCK_CHIME = getRegisteredSoundEvent("block.note.chime");
            BLOCK_NOTE_BLOCK_FLUTE = getRegisteredSoundEvent("block.note.flute");
            BLOCK_NOTE_BLOCK_GUITAR = getRegisteredSoundEvent("block.note.guitar");
            BLOCK_NOTE_BLOCK_HARP = getRegisteredSoundEvent("block.note.harp");
            BLOCK_NOTE_BLOCK_HAT = getRegisteredSoundEvent("block.note.hat");
            BLOCK_NOTE_BLOCK_PLING = getRegisteredSoundEvent("block.note.pling");
            BLOCK_NOTE_BLOCK_SNARE = getRegisteredSoundEvent("block.note.snare");
            BLOCK_NOTE_BLOCK_XYLOPHONE = getRegisteredSoundEvent("block.note.xylophone");
            ...
            ENTITY_PARROT_IMITATE_ENDER_DRAGON = getRegisteredSoundEvent("entity.parrot.imitate.enderdragon");
            ...
            ENTITY_PARROT_IMITATE_EVOKER = getRegisteredSoundEvent("entity.parrot.imitate.evocation_illager");
            ...
            ENTITY_PARROT_IMITATE_ILLUSIONER = getRegisteredSoundEvent("entity.parrot.imitate.illusion_illager");
            ENTITY_PARROT_IMITATE_MAGMA_CUBE = getRegisteredSoundEvent("entity.parrot.imitate.magmacube");
            ...
            ENTITY_PARROT_IMITATE_VINDICATOR = getRegisteredSoundEvent("entity.parrot.imitate.vindication_illager");
            ...
            ENTITY_POLAR_BEAR_AMBIENT_BABY = getRegisteredSoundEvent("entity.polar_bear.baby_ambient");
            ...
            MUSIC_DISC_11 = getRegisteredSoundEvent("record.11");
            MUSIC_DISC_13 = getRegisteredSoundEvent("record.13");
            MUSIC_DISC_BLOCKS = getRegisteredSoundEvent("record.blocks");
            MUSIC_DISC_CAT = getRegisteredSoundEvent("record.cat");
            MUSIC_DISC_CHIRP = getRegisteredSoundEvent("record.chirp");
            MUSIC_DISC_FAR = getRegisteredSoundEvent("record.far");
            MUSIC_DISC_MALL = getRegisteredSoundEvent("record.mall");
            MUSIC_DISC_MELLOHI = getRegisteredSoundEvent("record.mellohi");
            MUSIC_DISC_STAL = getRegisteredSoundEvent("record.stal");
            MUSIC_DISC_STRAD = getRegisteredSoundEvent("record.strad");
            MUSIC_DISC_WAIT = getRegisteredSoundEvent("record.wait");
            MUSIC_DISC_WARD = getRegisteredSoundEvent("record.ward");
            ...
            BLOCK_SLIME_BLOCK_BREAK = getRegisteredSoundEvent("block.slime.break");
            ENTITY_SLIME_DEATH = getRegisteredSoundEvent("entity.slime.death");
            BLOCK_SLIME_BLOCK_FALL = getRegisteredSoundEvent("block.slime.fall");
            BLOCK_SLIME_BLOCK_HIT = getRegisteredSoundEvent("block.slime.hit");
            ENTITY_SLIME_HURT = getRegisteredSoundEvent("entity.slime.hurt");
            ENTITY_SLIME_JUMP = getRegisteredSoundEvent("entity.slime.jump");
            BLOCK_SLIME_BLOCK_PLACE = getRegisteredSoundEvent("block.slime.place");
            ENTITY_SLIME_SQUISH = getRegisteredSoundEvent("entity.slime.squish");
            BLOCK_SLIME_BLOCK_STEP = getRegisteredSoundEvent("block.slime.step");
            ENTITY_MAGMA_CUBE_DEATH_SMALL = getRegisteredSoundEvent("entity.small_magmacube.death");
            ENTITY_MAGMA_CUBE_HURT_SMALL = getRegisteredSoundEvent("entity.small_magmacube.hurt");
            ENTITY_MAGMA_CUBE_SQUISH_SMALL = getRegisteredSoundEvent("entity.small_magmacube.squish");
            ENTITY_SLIME_DEATH_SMALL = getRegisteredSoundEvent("entity.small_slime.death");
            ENTITY_SLIME_HURT_SMALL = getRegisteredSoundEvent("entity.small_slime.hurt");
            ENTITY_SLIME_JUMP_SMALL = getRegisteredSoundEvent("entity.small_slime.jump");
            ENTITY_SLIME_SQUISH_SMALL = getRegisteredSoundEvent("entity.small_slime.squish");
            ENTITY_SNOWBALL_THROW = getRegisteredSoundEvent("entity.snowball.throw");
            ENTITY_SNOW_GOLEM_AMBIENT = getRegisteredSoundEvent("entity.snowman.ambient");
            ENTITY_SNOW_GOLEM_DEATH = getRegisteredSoundEvent("entity.snowman.death");
            ENTITY_SNOW_GOLEM_HURT = getRegisteredSoundEvent("entity.snowman.hurt");
            ENTITY_SNOW_GOLEM_SHOOT = getRegisteredSoundEvent("entity.snowman.shoot");
            ...
            BLOCK_STONE_PRESSURE_PLATE_CLICK_OFF = getRegisteredSoundEvent("block.stone_pressureplate.click_off");
            BLOCK_STONE_PRESSURE_PLATE_CLICK_ON = getRegisteredSoundEvent("block.stone_pressureplate.click_on");
            ...
            ENTITY_VILLAGER_TRADE = getRegisteredSoundEvent("entity.villager.trading");
            ENTITY_VILLAGER_YES = getRegisteredSoundEvent("entity.villager.yes");
            ENTITY_VINDICATOR_AMBIENT = getRegisteredSoundEvent("entity.vindication_illager.ambient");
            ENTITY_VINDICATOR_DEATH = getRegisteredSoundEvent("entity.vindication_illager.death");
            ENTITY_VINDICATOR_HURT = getRegisteredSoundEvent("entity.vindication_illager.hurt");
            BLOCK_LILY_PAD_PLACE = getRegisteredSoundEvent("block.waterlily.place");
            ...
            BLOCK_WOODEN_BUTTON_CLICK_OFF = getRegisteredSoundEvent("block.wood_button.click_off");
            BLOCK_WOODEN_BUTTON_CLICK_ON = getRegisteredSoundEvent("block.wood_button.click_on");
            ...
            BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF = getRegisteredSoundEvent("block.wood_pressureplate.click_off");
            BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON = getRegisteredSoundEvent("block.wood_pressureplate.click_on");
            ...
            ENTITY_ZOMBIE_ATTACK_WOODEN_DOOR = getRegisteredSoundEvent("entity.zombie.attack_door_wood");
            ENTITY_ZOMBIE_ATTACK_IRON_DOOR = getRegisteredSoundEvent("entity.zombie.attack_iron_door");
            ENTITY_ZOMBIE_BREAK_WOODEN_DOOR = getRegisteredSoundEvent("entity.zombie.break_door_wood");
            ...
            ENTITY_ZOMBIE_PIGMAN_AMBIENT = getRegisteredSoundEvent("entity.zombie_pig.ambient");
            ENTITY_ZOMBIE_PIGMAN_ANGRY = getRegisteredSoundEvent("entity.zombie_pig.angry");
            ENTITY_ZOMBIE_PIGMAN_DEATH = getRegisteredSoundEvent("entity.zombie_pig.death");
            ENTITY_ZOMBIE_PIGMAN_HURT = getRegisteredSoundEvent("entity.zombie_pig.hurt");
