...
public class GuiMainMenu extends GuiScreen {
    ...
    private void addSingleplayerMultiplayerButtons(int yIn, int rowHeightIn) {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, yIn + rowHeightIn * 1, I18n.format("menu.multiplayer")));
        this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 - 100, yIn + rowHeightIn * 2, I18n.format("menu.online")));
    }
