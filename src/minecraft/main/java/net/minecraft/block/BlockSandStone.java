...
public class BlockSandStone extends Block
{
    ...
    {
        super(Material.ROCK);
        this.setDefaultState(this.stateContainer.getBaseState().withProperty(TYPE, BlockSandStone.EnumType.DEFAULT));
        this.setCreativeTab(CreativeTabs.BUILDING_BLOCKS);
    }

    public int damageDropped(IBlockState state)
    {
        return ((BlockSandStone.EnumType)state.get(TYPE)).getMetadata();
    }
