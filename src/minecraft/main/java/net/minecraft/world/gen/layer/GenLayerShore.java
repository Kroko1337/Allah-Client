        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k == Biome.getIdForBiome(Biomes.MUSHROOM_FIELDS))
                {
                    ...
                    {
                        aint1[j + i * areaWidth] = Biome.getIdForBiome(Biomes.MUSHROOM_FIELD_SHORE);
                    }
                }
                ...
                else if (k != Biome.getIdForBiome(Biomes.MOUNTAINS) && k != Biome.getIdForBiome(Biomes.WOODED_MOUNTAINS) && k != Biome.getIdForBiome(Biomes.MOUNTAIN_EDGE))
                {
                    ...
                    {
                        this.replaceIfNeighborOcean(aint, aint1, j, i, areaWidth, k, Biome.getIdForBiome(Biomes.SNOWY_BEACH));
                    }
                ...
                {
                    this.replaceIfNeighborOcean(aint, aint1, j, i, areaWidth, k, Biome.getIdForBiome(Biomes.STONE_SHORE));
                }
            }
        }
