...
public class TextureAtlasSprite
{
    ...
    {
        this.x = atlasSpirit.x;
        this.y = atlasSpirit.y;
    ...
    public void updateAnimation()
    {
        ...
        if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter))
        {
            ...
            {
                TextureUtil.uploadTextureMipmap(this.framesTextureData.get(k), this.width, this.height, this.x, this.y, false, false);
            }
        }
    ...
    private void updateAnimationInterpolated()
    {
        ...
        if (i != k && k >= 0 && k < this.framesTextureData.size())
        {
            ...
            TextureUtil.uploadTextureMipmap(this.interpolatedFrameData, this.width, this.height, this.x, this.y, false, false);
        }
    }
    ...
    {
        return "TextureAtlasSprite{name='" + this.iconName + '\'' + ", frameCount=" + this.framesTextureData.size() + ", rotated=" + this.rotated + ", x=" + this.x + ", y=" + this.y + ", height=" + this.height + ", width=" + this.width + ", u0=" + this.minU + ", u1=" + this.maxU + ", v0=" + this.minV + ", v1=" + this.maxV + '}';
    }
}
