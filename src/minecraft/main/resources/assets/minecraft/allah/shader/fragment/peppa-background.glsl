/*
 * Original shader from: https://www.shadertoy.com/view/3sdcDM
 * Resolution and lightning fixed by HussNuss
 */
...
vec3 pepa(float x, float y)
{
    ...
    // cien
    c = 1.1+0.45*circledistin(x-0.55,y-0.815,0.18);
...
{
    vec2 p = (fragCoord.xy/iResolution.x/(0.5));
