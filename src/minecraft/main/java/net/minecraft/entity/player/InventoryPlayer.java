...
public class InventoryPlayer implements IInventory {
    ...
    public ItemStack getCurrentItem(boolean silent) {
        if (this.player == Minecraft.getMinecraft().player && silent) {
            return isHotbar(PlayerHandler.INSTANCE.getCurrentItem()) ? (ItemStack) this.mainInventory.get(PlayerHandler.INSTANCE.getCurrentItem()) : ItemStack.EMPTY;
        }
    ...
    public void setPickedItemStack(ItemStack stack) {
        ...
        if (isHotbar(i)) {
            ...
            if (i == -1) {
                ...
                if (this.player == Minecraft.getMinecraft().player)
                    PlayerHandler.INSTANCE.setCurrentItem(this.getBestHotbarSlot());
    ...
    public void changeCurrentItem(int direction) {
        ...
        if (this.player == Minecraft.getMinecraft().player)
            while (PlayerHandler.INSTANCE.getCurrentItem() >= 9)
                PlayerHandler.INSTANCE.setCurrentItem(PlayerHandler.INSTANCE.getCurrentItem() - 9);
    }
    ...
    public float getDestroySpeed(IBlockState state) {
        ...
        final int item = player == Minecraft.getMinecraft().player ? PlayerHandler.INSTANCE.getCurrentItem() : this.currentItem;
        if (!((ItemStack) this.mainInventory.get(item)).isEmpty()) {
            f *= ((ItemStack) this.mainInventory.get(item)).getDestroySpeed(state);
        }
    ...
    public boolean canHarvestBlock(IBlockState state) {
        if (state.getMaterial().isToolNotRequired()) {
            ...
            ItemStack itemstack = this.getStackInSlot(player == Minecraft.getMinecraft().player ? PlayerHandler.INSTANCE.getCurrentItem() : this.currentItem);
