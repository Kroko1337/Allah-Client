...
public class TextureUtils
{
    ...
    {
        if (!p_fixResourceLocation_0_.getNamespace().equals("minecraft"))
        {
            return p_fixResourceLocation_0_;
        }
        else
        {
            String s = p_fixResourceLocation_0_.getPath();
            String s1 = fixResourcePath(s, p_fixResourceLocation_1_);

            if (s1 != s)
            {
                p_fixResourceLocation_0_ = new ResourceLocation(p_fixResourceLocation_0_.getNamespace(), s1);
            }
