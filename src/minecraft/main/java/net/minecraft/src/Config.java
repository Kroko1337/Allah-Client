...
public class Config
{
    ...
    public static final String OF_RELEASE = "C5";
    public static final String VERSION = "OptiFine_1.12.2_HD_U_C5";
    ...
    {
        return "OptiFine_1.12.2_HD_U_C5";
    }
    ...
    public static String getVersionDebug()
    {
        ...
        stringbuffer.append("OptiFine_1.12.2_HD_U_C5");
