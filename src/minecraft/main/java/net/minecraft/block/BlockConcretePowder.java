...
public class BlockConcretePowder extends BlockFalling
{
    ...
    public void onEndFalling(World worldIn, BlockPos pos, IBlockState fallingState, IBlockState hitState)
    {
        ...
        {
            worldIn.setBlockState(pos, Blocks.CONCRETE.getDefaultState().withProperty(BlockColored.COLOR, fallingState.get(COLOR)), 3);
        }
    }
    ...
    protected boolean tryTouchWater(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (flag)
        {
            worldIn.setBlockState(pos, Blocks.CONCRETE.getDefaultState().withProperty(BlockColored.COLOR, state.get(COLOR)), 3);
        }
