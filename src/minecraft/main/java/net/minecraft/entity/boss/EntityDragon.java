...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob
{
    ...
    public EntityDragon(World worldIn)
    {
        ...
        if (!worldIn.isRemote && worldIn.dimension instanceof WorldProviderEnd)
        {
            this.fightManager = ((WorldProviderEnd)worldIn.dimension).getDragonFightManager();
        }
        else
        {
    ...
    public void livingTick()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                this.dragonPartRightWing.height = 2.0F;
                this.dragonPartRightWing.width = 4.0F;
                this.dragonPartLeftWing.height = 3.0F;
                this.dragonPartLeftWing.width = 4.0F;
    ...
    private void updateDragonEnderCrystal()
    {
        ...
        {
            List<EntityEnderCrystal> list = this.world.<EntityEnderCrystal>getEntitiesWithinAABB(EntityEnderCrystal.class, this.getBoundingBox().grow(32.0D));
