...
public class GameSettings
{
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
        ...
        {
            this.cloudOption = (this.cloudOption + value) % 3;
        }
        ...
        {
            this.ambientOcclusionStatus = (this.ambientOcclusionStatus + value) % 3;
            this.mc.worldRenderer.loadRenderers();
        }
    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        {
            return s + getTranslation(PARTICLES, this.particles);
        }
        else if (settingOption == GameSettings.Options.AMBIENT_OCCLUSION)
        {
            return s + getTranslation(AMBIENT_OCCLUSIONS, this.ambientOcclusionStatus);
        }
        else if (settingOption == GameSettings.Options.RENDER_CLOUDS)
        {
            return s + getTranslation(CLOUDS_TYPES, this.cloudOption);
        }
    ...
    private NBTTagCompound dataFix(NBTTagCompound nbt)
    {
        ...
        return this.mc.getDataFixer().process(FixTypes.OPTIONS, nbt, i);
    }
